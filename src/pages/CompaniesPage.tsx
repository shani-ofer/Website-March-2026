      ...
      <section className="py-12 md:py-20 px-6 bg-warm-white">
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="space-y-5 text-[#555] body-text leading-relaxed max-w-3xl mb-10">
            <p>
              אני עופר שני. לאורך מעל 25 שנה הקמתי והובלתי חברת טכנולוגיה דרך מספר שלבי צמיחה, ניהלתי צוותים גלובליים בפיתוח, מוצר, תפעול ותמיכה, ועבדתי בתעשיות החל מטלקום וטכנולוגיה רפואית ועד גיימינג ומרטק.
            </p>
