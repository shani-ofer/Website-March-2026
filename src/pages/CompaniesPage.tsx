      ...
      <section className="py-12 md:py-20 px-6 bg-white">
        <div className="max-w-[1000px] mx-auto">
          ...
          <p className="text-[#555] body-text leading-relaxed max-w-3xl mb-12">
            אני עובד עם מנהלים באחד-על-אחד, ומתמקד באתגרים האמיתיים שהם מתמודדים איתם ביומיום. מאתגרים אופרטיווים לאתגרים שדורשים soft skills. כל התקשרות מתחילה בהבנת הארגון שלכם, האנשים שלכם, והפערים הספציפיים שאתם רוצים לסגור.
          </p>
