    ...
    <div className="flex flex-col">
        ...
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-10 items-start">
            <div className="space-y-5 text-[#555] body-text leading-relaxed max-w-3xl flex-1">
              ...
              <p>
                הנסיון בניהול והובלה באירגונים שונים שפועלים בתחומי עיסוק שונים לימד אותי רבות ומאפשר לי ללוות מנהלים במגוון רחב של תפקידים וחברות. היום, אני מביא את כל הניסיון הזה לתהליכי חניכה ויעוץ אותם אני עושה בשני נתיבים, האחד עם אנשים באופן פרטי בתחום הקרירה והשני עם חברות שרוצות לחזק את המנהלים שלהן. הגישה שלי נטועה בניסיון מהעולם האמיתי והאמונה שהתוצאות הטובות ביותר מגיעות כשמשקיעים קודם כל באנשים.
              </p>
      ...
      <section className="relative py-12 md:py-20 px-6">
        ...
        <div className="relative z-10 max-w-[1000px] mx-auto">
          <h2 className="text-black mb-3 drop-shadow-lg">לאמן מנהלים להוביל, לא רק לנהל</h2>
          <p className="text-[18px] md:text-[22px] font-medium text-black mb-12 drop-shadow-md">
